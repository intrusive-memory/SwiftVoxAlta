...
struct DigaDualModelIntegrationTests {
    ...
    func dualModelGeneration() async throws {
        ...
        #expect(result0_6b.exitCode == 0, "0.6B generation should succeed, stderr: \(result0_6b.stderr)")
        ...
        #expect(result1_7b.exitCode == 0, "1.7B generation should succeed, stderr: \(result1_7b.stderr)")
        ...
        let size0_6b = try FileManager.default.attributesOfItem(atPath: outputPath0_6b)[.size] as? Int ?? 0
        let size1_7b = try FileManager.default.attributesOfItem(atPath: outputPath1_7b)[.size] as? Int ?? 0
        let sizesDiffer = size0_6b != size1_7b
        let rmsDiffers = abs(rms0_6b - rms1_7b) > 0.001

        #expect(sizesDiffer || rmsDiffers,
            "Models should produce different output (sizes: \(size0_6b) vs \(size1_7b), RMS: \(rms0_6b) vs \(rms1_7b))")

        print("Dual-model test passed: 0.6B(\(size0_6b)B, RMS=\(String(format: "%.4f", rms0_6b))) vs 1.7B(\(size1_7b)B, RMS=\(String(format: "%.4f", rms1_7b)))")
    }
