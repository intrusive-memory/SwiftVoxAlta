...
struct TextChunkerTests {
  ...
  func chunkBoundariesOnSentenceBoundaries() {
    ...
    let s2 =
      "Meanwhile the cat sat on the warm windowsill watching birds fly past the garden fence."
    let s3 =
      "A gentle breeze carried the scent of fresh flowers across the meadow where children played."
  ...
  func customMaxWords() {
    ...
    #expect(
      chunks30.count > chunks200.count,
...
struct WAVConcatenatorTests {
  ...
  func twoSegmentsConcatenate() throws {
    ...
    #expect(
      dataChunkSize == expectedDataSize,
