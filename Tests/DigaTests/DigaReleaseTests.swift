...
struct DigaReleaseTests {
  ...
  func releaseWorkflowPackaging() throws {
    ...
    #expect(
      content.contains("shasum -a 256") || content.contains("sha256"),
      "release.yml should compute SHA256")
  }
  ...
  func formulaCaveats() throws {
    ...
    #expect(
      content.contains("Qwen3-TTS") || content.contains("model"),
      "Caveats should mention model download")
  }
